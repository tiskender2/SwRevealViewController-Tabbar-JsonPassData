...
class TabilkViewController: UIViewController {
    ...
    func custimizeNavBar()
    {
        ...
        navigationController?.navigationBar.barTintColor = UIColor(colorLiteralRed: 142/255, green: 71/255, blue: 71/255, alpha: 1)
